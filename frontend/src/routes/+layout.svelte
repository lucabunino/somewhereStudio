...
/**
 * Custom vertical flip animation that accounts for margin/padding/pseudo.
 * @param {HTMLElement} node
 * @param {{ from: DOMRect; to: DOMRect }} { from, to }
 */
